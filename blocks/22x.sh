echo -e " \e[32mBlock 220.x\e[0m"
sudo iptables -A bannedDownloader -s 220.66.155.2 -j DROP
sudo iptables -A bannedDownloader -s 220.134.194.168 -j DROP
...
sudo iptables -A bannedDownloader -s 220.225.7.81 -j DROP
...
sudo iptables -A bannedDownloader -s 222.165.182.42 -j DROP
...
sudo iptables -A bannedDownloader -s 222.253.42.14 -j DROP
sudo iptables -A bannedDownloader -s 222.253.144.254 -j DROP
...
sudo iptables -A bannedDownloader -s 223.197.135.155 -j DROP
