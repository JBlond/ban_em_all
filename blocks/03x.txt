...
sudo iptables -A bannedDownloader -s 34.74.45.146 -j DROP
sudo iptables -A bannedDownloader -s 34.87.148.133 -j DROP
sudo iptables -A bannedDownloader -s 34.89.240.43 -j DROP # scanner
sudo iptables -A bannedDownloader -s 34.93.16.66 -j DROP
sudo iptables -A bannedDownloader -s 34.147.141.72 -j DROP
...
sudo iptables -A bannedDownloader -s 35.205.224.248 -j DROP
sudo iptables -A bannedDownloader -s 35.209.9.73 -j DROP
sudo iptables -A bannedDownloader -s 35.219.66.183 -j DROP
sudo iptables -A bannedDownloader -s 35.226.196.179 -j DROP
...
sudo iptables -A bannedDownloader -s 35.245.96.16 -j DROP
...
sudo iptables -A bannedDownloader -s 37.187.149.168 -j DROP
