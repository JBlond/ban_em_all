...
sudo iptables -A bannedDownloader -s 143.110.244.123 -j DROP
...
sudo iptables -A bannedDownloader -s 144.76.15.243 -j DROP
...
sudo iptables -A bannedDownloader -s 144.217.181.137 -j DROP
