...
sudo iptables -A bannedDownloader -s 3.29.10.88 -j DROP
...
sudo iptables -A bannedDownloader -s 8.210.82.97 -j DROP
...
sudo iptables -A bannedDownloader -s 8.218.115.242 -j DROP
