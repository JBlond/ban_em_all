...
sudo iptables -A bannedDownloader -s 40.77.107.181 -j DROP
sudo iptables -A bannedDownloader -s 40.77.111.208 -j DROP
...
sudo iptables -A bannedDownloader -s 40.121.42.137 -j DROP # WP scanner
...
sudo iptables -A bannedDownloader -s 42.193.200.167 -j DROP
...
sudo iptables -A bannedDownloader -s 47.128.17.107 -j DROP
sudo iptables -A bannedDownloader -s 47.128.22.21 -j DROP
sudo iptables -A bannedDownloader -s 47.128.26.62 -j DROP

sudo iptables -A bannedDownloader -s 49.12.69.71 -j DROP
...
sudo iptables -A bannedDownloader -s 49.232.70.69 -j DROP
