...
sudo iptables -A bannedDownloader -s 114.98.0.0/16 -j REJECT
...
sudo iptables -A bannedDownloader -s 122.224.0.0/16  -j REJECT
...
sudo iptables -A bannedDownloader -s 124.114.0.0/16 -j REJECT
