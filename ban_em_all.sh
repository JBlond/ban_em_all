...
sudo iptables -A bannedDownloader -s 87.251.122.178 -j DROP # RU
...
sudo iptables -A bannedDownloader -s 221.229.0.0/16 -j DROP
sudo iptables -A bannedDownloader -s 222.186.0.0/15 -j DROP
...
sudo iptables -A INPUT -p tcp --dport 8086 -j REJECT --reject-with tcp-reset
